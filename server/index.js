...
const MOUNTS = [
  ...
  'T5_MOUNT_ARMORED_HORSE', 'T6_MOUNT_ARMORED_HORSE', 'T7_MOUNT_ARMORED_HORSE', 'T8_MOUNT_ARMORED_HORSE',
  'T5_MOUNT_ARMORED_HORSE_SKIN_01', 'T6_MOUNT_ARMORED_HORSE_SKIN_01', 'T7_MOUNT_ARMORED_HORSE_SKIN_01', 'T8_MOUNT_ARMORED_HORSE_SKIN_01',
  // Bueyes
  ...
  'T5_MOUNT_OWL_FW_BRECILIEN', 'T8_MOUNT_OWL_FW_BRECILIEN_ELITE',
  // Mamuts
  'T8_MOUNT_MAMMOTH_BATTLE@1', 'T8_MOUNT_MAMMOTH_TRANSPORT',
  // Otros T7–T8
  'T7_MOUNT_MONITORLIZARD_ADC',
  'T6_MOUNT_SIEGE_BALLISTA',
  'T5_MOUNT_COUGAR_KEEPER@1', 'T8_MOUNT_COUGAR_KEEPER@1',
  'T8_MOUNT_HORSE_UNDEAD@1',
  'T8_MOUNT_ARMORED_HORSE_MORGANA@1',
  'T8_MOUNT_RABBIT_EASTER', 'T8_MOUNT_RABBIT_EASTER_DARK@1',
  // UNIQUE
  'UNIQUE_MOUNT_BAT_PERSONAL', 'UNIQUE_MOUNT_BAT_TELLAFRIEND',
  'UNIQUE_MOUNT_BEAR_KEEPER_ADC',
  'UNIQUE_MOUNT_BEETLE_CRYSTAL', 'UNIQUE_MOUNT_BEETLE_GOLD', 'UNIQUE_MOUNT_BEETLE_SILVER',
  'UNIQUE_MOUNT_BEHEMOTH_CRYSTAL', 'UNIQUE_MOUNT_BEHEMOTH_GOLD', 'UNIQUE_MOUNT_BEHEMOTH_SILVER',
  'UNIQUE_MOUNT_BLACK_PANTHER_ADC',
  'UNIQUE_MOUNT_ARMORED_EAGLE_CRYSTAL', 'UNIQUE_MOUNT_ARMORED_EAGLE_GOLD', 'UNIQUE_MOUNT_ARMORED_EAGLE_SILVER',
  'UNIQUE_MOUNT_BASTION_CRYSTAL', 'UNIQUE_MOUNT_BASTION_GOLD', 'UNIQUE_MOUNT_BASTION_SILVER',
  'UNIQUE_MOUNT_BATTLESPIDER_CRYSTAL', 'UNIQUE_MOUNT_BATTLESPIDER_GOLD', 'UNIQUE_MOUNT_BATTLESPIDER_SILVER',
  'UNIQUE_MOUNT_DIVINE_OWL_ADC',
  'UNIQUE_MOUNT_ENT_CRYSTAL', 'UNIQUE_MOUNT_ENT_GOLD', 'UNIQUE_MOUNT_ENT_SILVER',
  'UNIQUE_MOUNT_GIANT_HORSE_ADC',
  'UNIQUE_MOUNT_GIANTTOAD_TELLAFRIEND', 'UNIQUE_MOUNT_GIANTTOAD_02_TELLAFRIEND',
  ...
  'UNIQUE_MOUNT_RAM_TELLAFRIEND', 'UNIQUE_MOUNT_RAM_XMAS',
  'UNIQUE_MOUNT_RHINO_SEASON_BRONZE', 'UNIQUE_MOUNT_RHINO_SEASON_SILVER', 'UNIQUE_MOUNT_RHINO_SEASON_GOLD', 'UNIQUE_MOUNT_RHINO_SEASON_CRYSTAL',
  'UNIQUE_MOUNT_TANKBEETLE_CRYSTAL', 'UNIQUE_MOUNT_TANKBEETLE_GOLD', 'UNIQUE_MOUNT_TANKBEETLE_SILVER',
